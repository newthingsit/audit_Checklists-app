    ...
    <Box sx={{ 
      ...
      '&::before': {
        ...
        background: `
          ...
          radial-gradient(circle at 60% 60%, rgba(139, 92, 246, 0.08) 0%, transparent 40%)
        `,
      ...
      <Box sx={{
        ...
        height: 300,
        borderRadius: '50%',
        background: 'linear-gradient(135deg, rgba(13, 148, 136, 0.08) 0%, rgba(8, 145, 178, 0.04) 100%)',
        bottom: '-100px',
        right: '-100px',
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <PersonIcon sx={{ color: themeConfig.text.secondary }} />
                    </InputAdornment>
                  ),
                }}
                sx={{ 
